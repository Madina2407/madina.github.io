...
.catch(error => console.log(error))
 ...
 function renderProducts(productList) {
        ...
        productList.forEach(({ id, name, email, image_url, address, company }) => {
    ...
    <div>
        ...
        <h3>Location:</h3> <span>${address.street}${address.suite}${address.city}</span>
        <h3>Company:</h3> <span>${company.name}</span>
